    ...
    <div className="hero-section  bg-hero-black text-white flex justify-center items-center w-full">
      <div className="desktop-container w-full hero-section text-white p-8 flex justify-between items-center">
        <div className="flex flex-col space-y-8">
          ...
          <button className="mt-8 px-8 py-4 bg-white text-black font-semibold rounded-full shadow-white/50 shadow-lg transition transform hover:scale-105">Reserve Now</button>
        </div>
        <img
          src="/chess.png"
          alt="chess pieces"
