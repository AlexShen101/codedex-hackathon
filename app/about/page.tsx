  ...
  return (
    <>
      <div className="flex items-center h-60v bg-black">
        <h1 className="text-6xl font-bold text-white float-left ml-[15%] z-10">About Sip & Play</h1>
        <img src="https://placehold.co/300x500" alt="Person wearing a Sip & Play t-shirt with arms crossed" className="rounded-full shadow-lg absolute right-[30%]" />
      </div>
      <div className="max-w-6xl mx-auto p-8">
        ...
        <Image src="/storefront.png" alt="Storefront of Sip & Play with a sign that says 'Sip & Play' and a large window with a view of the cafe" className="rounded-xl shadow-md" width={1600} height={883} />
      </div>
    </>
  );
}
